...
Меня зовут Никита. Я являюсь специалистом по тестированию игр.
#

Интересуюсь разработкой и автоматизацией тестирования. Основной язык - Python, но так же интересуюсь JavaScript совместно с HTML & CSS. 
